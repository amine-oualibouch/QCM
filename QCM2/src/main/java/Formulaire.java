...
public class Formulaire extends QCM {
  ...
  public void chargement() {
    ...
    try {
      ...
      connection = DriverManager.getConnection("jdbc:mysql://localhost/dbqcm", "root", "1234");
  ...
  public void affichageHTML() {
    ...
    for (String string : formulaires) {
      if (string.toLowerCase().contains("mysql")) {
        htmlStrings += "<li><a  href='/QCM2/question.jsp?page=1'>" + string + "</a></li>";
       // htmlStrings += "<jsp:param name=\"mysql\" value=\"1\"/>";
      }
      else {
        htmlStrings += "<li><a  href='/QCM2/question.jsp?page=2'>" + string + "</a></li>";
